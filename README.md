...
```
$ python -m op_return_reader 2033435de7ce307341231e818ed937cd3a5e8597381fd83a7e5b0234f61b38d3
...
| (_) |  _/ |   / _|  | | | |_| |   / .` |
 \___/|_|   |_|_\___| |_|  \___/|_|_\_|\_|
  ...
  Output #1
  ├─ Size:     20 bytes
  ├─ Hex:      215477656e74792062797465206469676573742e
  └─ Message:  !Twenty byte digest.
```
  ...
  "outputs": [
    {
      "txid": "2033435de7ce307341231e818ed937cd3a5e8597381fd83a7e5b0234f61b38d3",
      "vout_index": 1,
      "raw_hex": "215477656e74792062797465206469676573742e",
      "decoded_text": "!Twenty byte digest.",
      "size_bytes": 20
    }
  ]
}
...
| TXID | Description |
|---|---|
| `2033435de7ce307341231e818ed937cd3a5e8597381fd83a7e5b0234f61b38d3` | First OP_RETURN with ASCII text: "!Twenty byte digest." ([source](https://learnmeabitcoin.com/explorer/tx/)) |
| `f4ac7abcb689df30ec5e8d829733622f389ca91367c47b319bc582e653cd8cab` | "Craig Wright is a liar and a fraud" ([source](https://armantheparman.com/op_return_old/)) |
